        ...
        <div className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-amber-700 mt-1">
              Set <code className="bg-amber-100 px-1 py-0.5 rounded">NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY</code> and{' '}
              <code className="bg-amber-100 px-1 py-0.5 rounded">CLERK_SECRET_KEY</code> environment variables
