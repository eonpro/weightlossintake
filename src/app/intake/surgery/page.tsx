  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="px-6 lg:px-8 pt-6">
        <Link href="/intake/pregnancy" className="inline-block p-2 -ml-2 hover:bg-gray-100 rounded-lg">
          ...
          <div className="space-y-3">
            ...
            >
              <div className={`w-6 h-6 rounded border-2 flex items-center justify-center mr-3 transition-all ${
                selected === 'yes' ? 'bg-[#f0feab] border-[#f0feab]' : 'bg-white border-gray-300'
              }`}>
                {selected === 'yes' && (
            ...
            >
              <div className={`w-6 h-6 rounded border-2 flex items-center justify-center mr-3 transition-all ${
                selected === 'no' ? 'bg-[#f0feab] border-[#f0feab]' : 'bg-white border-gray-300'
              }`}>
                {selected === 'no' && (
                  <svg className="w-4 h-4 text-black" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
