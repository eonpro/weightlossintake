...
export default function DiabetesPersonalPage() {
  ...
  const handleContinue = () => {
    if (selected) {
      sessionStorage.setItem('personal_diabetes_t2', selected);
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="px-6 lg:px-8 pt-8 lg:pt-6">
        <Link href="/intake/gastroparesis-personal" className="inline-block p-2 -ml-2 hover:bg-white/10 rounded-lg">
      ...
      <div className="flex-1 flex flex-col px-6 lg:px-8 py-8 pb-40 max-w-md lg:max-w-2xl mx-auto w-full">
        <div className="space-y-8">
          <h1 className="page-title">
            {language === 'es' 
              ? '¿Tienes antecedentes personales de diabetes tipo 2?'
