...
export default function PancreatitisPersonalPage() {
  ...
  const handleContinue = () => {
    if (selected) {
      sessionStorage.setItem('personal_pancreatitis', selected);
      router.push('/intake/gastroparesis-personal');
    }
  };
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="px-6 lg:px-8 pt-6">
        <Link href="/intake/men-personal" className="inline-block p-2 -ml-2 hover:bg-gray-100 rounded-lg">
