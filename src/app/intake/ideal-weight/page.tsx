  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="w-full h-1 bg-white/20">
        <div className="h-full w-2/6 bg-[#b8e64a] transition-all duration-300"></div>
      </div>
      
      <div className="px-6 lg:px-8 pt-6 max-w-md lg:max-w-2xl mx-auto w-full">
        <Link href="/intake/address" className="inline-block p-2 -ml-2 hover:bg-white/10 rounded-lg">
