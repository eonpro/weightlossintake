...
export default function ThyroidCancerPersonalPage() {
  ...
  const handleContinue = () => {
    if (selected) {
      sessionStorage.setItem('personal_thyroid_cancer', selected);
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="px-6 lg:px-8 pt-6">
        <Link href="/intake/family-conditions" className="inline-block p-2 -ml-2 hover:bg-gray-100 rounded-lg">
      ...
      <div className="flex-1 flex flex-col px-6 lg:px-8 py-8 max-w-md lg:max-w-2xl mx-auto w-full">
        <div className="space-y-8">
          <h1 className="text-3xl font-medium leading-tight">
            {language === 'es' 
              ? '¿Tienes antecedentes personales de cáncer medular de tiroides?'
