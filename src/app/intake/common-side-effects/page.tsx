          ...
          <div className="space-y-3">
            {sideEffects.map((effect) => (
              <button
                ...
                className={`w-full px-4 py-3 text-left rounded-2xl transition-all flex items-start ${
                  selectedItems.includes(effect.id)
                    ? 'bg-[#f0feab] border-2 border-[#4fa87f]'
                    : 'bg-white border-2 border-gray-200 hover:border-[#4fa87f]'
                }`}
              >
                <div className={`w-5 h-5 flex-shrink-0 rounded border-2 flex items-center justify-center mr-3 mt-0.5 transition-all ${
                ...
                <div className="leading-none">
                  <span className="text-base lg:text-lg text-[#413d3d] leading-tight">
