...
# Script to update intake pages with the new mobile-optimized button layout
# This ensures the Continue button is always visible at the bottom on mobile

echo "🔄 Updating intake pages for mobile button layout..."

# Update the state page
cat << 'EOF' > src/app/intake/state/page-update.tsx
'use client';
...
mv src/app/intake/state/page-update.tsx src/app/intake/state/page.tsx

echo "✅ Updated state page with mobile button layout"
echo ""
echo "📱 Mobile Layout Features:"
echo "   • Continue button fixed at bottom of screen"
echo "   • Content scrolls behind button when needed"
echo "   • 16px text size on all mobile inputs"
echo "   • Clean separation between content and actions"
